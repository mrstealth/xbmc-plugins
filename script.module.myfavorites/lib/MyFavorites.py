...
class MyFavoritesDB():
    def __init__(self, plugin):
        ...
        self.database_dir = xbmc.translatePath(self.addon.getAddonInfo('profile'))
        self.database_file = os.path.join(self.database_dir, 'favorites.sqlite')
    ...
    def connect(self):
        try: 
            ...
            print "Database diretory doesn't exist, create !!!"
...
class MyFavorites():
    def __init__(self, plugin):
        self.id = 'script.module.myfavorites'
